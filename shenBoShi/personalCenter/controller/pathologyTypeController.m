...
@interface pathologyTypeController ()

@end

@implementation pathologyTypeController
...
{
    if ([self.delegate respondsToSelector:@selector(sendWithString:)]) {
        [self.delegate sendWithString:array[indexPath.row]];
    }
